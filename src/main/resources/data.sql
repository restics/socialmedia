-- =============================================
-- SEED DATA FOR SOCIAL MEDIA DATABASE
-- =============================================
-- Passwords are plaintext placeholders — swap for hashed values later
-- Profile pictures left NULL for now

-- =============================================
-- USERS
-- =============================================
INSERT INTO Users (user_id, password, email, name, profile_picture, bio) VALUES
                                                                             (1, 'pass1234', 'alice@email.com',    'alice',    NULL, 'caffeine-powered developer'),
                                                                             (2, 'pass1234', 'bob@email.com',      'bob',      NULL, 'hiking and hot takes'),
                                                                             (3, 'pass1234', 'charlie@email.com',  'charlie',  NULL, 'night owl. code goblin.'),
                                                                             (4, 'pass1234', 'diana@email.com',    'diana',    NULL, 'photographer + dog mom'),
                                                                             (5, 'pass1234', 'eve@email.com',      'eve',      NULL, 'math nerd, music snob'),
                                                                             (6, 'pass1234', 'frank@email.com',    'frank',    NULL, 'aspiring chef, eternal student'),
                                                                             (7, 'pass1234', 'grace@email.com',    'grace',    NULL, 'design + frontend things'),
                                                                             (8, 'pass1234', 'hank@email.com',     'hank',     NULL, 'gym rat. protein enthusiast.');

-- =============================================
-- POSTS (parent posts — parent_post_id IS NULL)
-- =============================================
...
INSERT INTO PostLike (post_id, user_id, created_at) VALUES
                                                        -- Post 1 (Alice's spring boot post) — 5 likes
                                                        ...
                                                        -- Post 6 (Charlie's rust vs go post) — 2 likes
                                                        (6, 1, '2026-04-15 02:25:00'),
                                                        (6, 2, '2026-04-15 06:00:00'),

                                                        -- Post 7 (Diana's sedona post) — 7 likes (most liked!)
                                                        ...
                                                        -- Post 11 (Grace's portfolio post) — 3 likes
                                                        (11, 1, '2026-04-14 17:00:00'),
                                                        (11, 3, '2026-04-14 18:00:00'),
                                                        (11, 5, '2026-04-14 19:00:00'),

                                                        -- Post 12 (Hank's deadlift post) — 2 likes
                                                        (12, 2, '2026-04-15 07:00:00'),
                                                        (12, 6, '2026-04-15 08:00:00'),

                                                        -- Some likes on replies (makes data more realistic)
                                                        (13, 1, '2026-04-10 09:35:00'),
                                                        (13, 5, '2026-04-10 10:10:00'),
                                                        (15, 1, '2026-04-10 10:15:00'),
                                                        (15, 2, '2026-04-10 10:30:00'),
                                                        (15, 7, '2026-04-10 11:00:00'),
                                                        (17, 1, '2026-04-10 14:00:00'),
                                                        (17, 3, '2026-04-10 15:00:00'),
                                                        (22, 1, '2026-04-11 19:30:00'),
                                                        (22, 4, '2026-04-11 20:00:00');
